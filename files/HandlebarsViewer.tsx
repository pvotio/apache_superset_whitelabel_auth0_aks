...
Handlebars.registerHelper('parseJson', function (jsonString: any) {
  return JSON.parse(jsonString);
});

Handlebars.registerHelper('distinctPortfolios', function (data: any) {
  const portfolioSet = new Set();
  data.forEach((item: any) => portfolioSet.add(item.portfolio));
  return Array.from(portfolioSet).join(',');
});
